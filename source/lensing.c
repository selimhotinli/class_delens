...
schedule (static)
    ...
    for(index_l_1=0; index_l_1<ple->l_size; index_l_1++){
        for(index_l_2=0; index_l_2<ple->l_size; index_l_2++){
            ...
            ple->cl_delens_derv_TT_TT[index_l_2][index_l_1]=cle*2.0*_PI_;
        }
    }
    return _SUCCESS_;
}
...
//                 printf("ksim=%e\n",ksim[(int)ple->l_dl[index_l_2]][imu]);
            ...
            ple->cl_delens_derv_EE_EE[index_l_2][index_l_1]=(clp+clm)*_PI_;
            ple->cl_delens_derv_EE_BB[index_l_2][index_l_1]=(clp-clm)*_PI_;
        }
    }
    return _SUCCESS_;
}
